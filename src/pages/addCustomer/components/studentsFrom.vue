    ...
    <div class="form-item">
      ...
      <el-form-item label="学生年级" label-width="100px">
        <el-cascader
          ...
          :options="listByCodeData_1[12] ? listByCodeData_1[12].dictDetailList:[]"
          :props="gadesProps"
          v-model="form.grade"
          placeholder="请输入学生年级"
        ></el-cascader>
    ...
    <div class="form-item">
      ...
      <el-form-item label="性格类型">
        <el-select v-model="form.personality" placeholder="请选择性格类型" style="width:200px" >
          <el-option v-for="(item,index) in (listByCodeData_1[6] ? listByCodeData_1[6].dictDetailList:[])"
            :key="index"
            :label="item.name"
