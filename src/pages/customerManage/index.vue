<template>
  <div>
    ...
    <follow-toast
      ...
      :form="form"
      @onCancel="onFollowCancel"
      @tagConfirm="tagConfirm"
    ></follow-toast>
    <add-lesson :lessonToast="lessonToast" :form="form" :lessonstate="lessonstate" @onCancel="closeClassDialog"></add-lesson>
  </div>
</template>
<script>
...
//import addLesson from "../components/addLessonToast/index.vue";
export default {
  components: {
    tagToast,
    followToast,
